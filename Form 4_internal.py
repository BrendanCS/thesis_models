...
class MotorModule(ccm.Model):
    ...
    def run(self):                                                     
        print "I've run to my appointment."                                 
...
class MyAgent(ACTR):   
  ...
  #############  FIRE ALARM
    ...
    def Remember(focus='competing production', utility=0.3):      # this produciton has a higher utility
        print "I forgot my appointment!"                          
        motor.run()                                              
        self.stop()
